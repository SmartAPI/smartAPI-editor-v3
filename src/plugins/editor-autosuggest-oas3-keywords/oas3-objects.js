...
// sd: extended for smartAPI metadata
...
export const Contact = {
  ...
  email: String,
  'x-id': String,
  'x-role': stringEnum(["responsible organization", "responsible developer", "contributor", "support"])
...
export const Info = {
  ...
  license: License,
  version: String,
  'x-accessRestriction': stringEnum(["none", "limited", "fee"]),
  'x-maturity': stringEnum(["development", "production"]),
  'x-implementationLanguage': String,
}
...
export const Parameter = {
  ...
  'x-parameterType': stringEnum(["InputParameter", "NumberOfResultsReturned", "OffsetParameter", "SortParameter"]),
  'x-valueType': [String],
}
...
export const Response = {
  ...
  'x-responseSchema': String,
  'x-responseValueType': Object,
  'x-JSONLDContext': String,
}
